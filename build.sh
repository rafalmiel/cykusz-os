...
i686-elf-gcc -T linker.ld -o myos.bin -ffreestanding -O2 -nostdlib boot.o kernel.o io.o common.o gdt.o descriptor_tables.o interrupt.o isr.o timer.o kheap.o -lgcc
