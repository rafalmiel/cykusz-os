...
i686-elf-gcc -c arch/x86/fs.c -o fs.o $flags
...
i686-elf-gcc -T linker.ld -o myos.bin -ffreestanding -O2 -g -nostdlib boot.o kernel.o io.o fs.o common.o ordered_array.o gdt.o descriptor_tables.o interrupt.o isr.o timer.o kheap.o paging.o frame.o -lgcc
